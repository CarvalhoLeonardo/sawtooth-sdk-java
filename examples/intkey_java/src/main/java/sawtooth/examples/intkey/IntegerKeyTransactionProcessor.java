/*
 * Copyright 2016 Intel Corporation Licensed under the Apache License, Version 2.0 (the "License");
...
public class IntegerKeyTransactionProcessor {
  ...
  public static void main(final String[] args) throws InterruptedException, ExecutionException {
    ...
    TransactionProcessor transactionProcessor =
        new DefaultTransactionProcessorImpl(args[0], args[1], Integer.parseInt(args[2]));
