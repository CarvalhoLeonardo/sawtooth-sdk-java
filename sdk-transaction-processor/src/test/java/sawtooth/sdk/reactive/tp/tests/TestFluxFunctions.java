...
public class TestFluxFunctions {
  ...
  public void setUp() throws NoSuchAlgorithmException{
    myMF = new MessageFactory("messagetest", "0.0.0", null, null, "messagetest");
    messageGenerator = new MessageGenerator(1);
    messageGenerator.startFluxFor(myMF);
  }
     ...
     .subscribe( cs -> {
          switch (cs.key()) {
            case 1:
              ...
              cs.subscribe(new SubscriberWithBackPressure<Message>(BACKPRESSURE_REQ,new Consumer<Message>() {
                @Override
