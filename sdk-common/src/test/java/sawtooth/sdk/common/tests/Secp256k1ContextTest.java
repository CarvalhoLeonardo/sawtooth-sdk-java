...
------------------------------------------------------------------------------*/
// @formatter:on
package sawtooth.sdk.common.tests;
...
import sawtooth.sdk.common.signing.PrivateKey;
import sawtooth.sdk.common.signing.PublicKey;
import sawtooth.sdk.common.signing.Secp256k1Context;
import sawtooth.sdk.common.signing.Secp256k1PrivateKey;
import sawtooth.sdk.common.signing.Secp256k1PublicKey;
import sawtooth.sdk.common.signing.Signer;
...
public class Secp256k1ContextTest {
  ...
  public void testPublicPrivateKey() {
    ...
    PrivateKey privateKey = Secp256k1PrivateKey
        .fromHex(Utils.HEX.encode(BigInteger.TEN.toByteArray()));
  ...
  public void testPublicPrivatePythonGeneratedKeys() {
    ...
    PrivateKey privateKey = Secp256k1PrivateKey
        .fromHex("80378f103c7f1ea5856d50f2dcdf38b97da5986e9b32297be2de3c8444c38c08");

    PublicKey publicKey = Secp256k1PublicKey
        .fromHex("0279b0fbdf73d8656c86ef6fe12c5de883ebb5a07126aa2ab655e6f8321cb4beed");

    Assert.assertEquals(
        "Calculating the public key from the private key with the context gets the same result as Python signer",
  ...
  public void testSignAndVerifyPythonCompatibility() throws UnsupportedEncodingException {
    ...
    Assert.assertEquals("The Java and Python signing are equivalent", signature,
